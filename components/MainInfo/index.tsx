...
const MainInfo: React.FC = () => (
  <section className={styles.container}>
    ...
    <div className={styles.hero}>
      ...
      <img src={heroBackground} alt="MindVersity strives to bridge the gaps between access to mental health resources and students of color on college campuses nationwide."/>
    </div>
    ...
    <div className={styles.aboutParent}>
      ...
      <div className={classNames(styles.aboutCol, styles.aboutBackgroundCol)}>
        <img src={aboutBackground} alt="MindVersity is a place for students of color to get easire access to mental health resources."></img>
      </div>
